...
export class SpriteGraphics extends GraphicsComponent {
	...
	constructor(scene: Scene, entity: Entity, image: any) {
        ...
        this.sequences = {};
        this.sequences["walk-right"] = { start:0, count:4, speed: 400, loop:true } as SpriteSequence;
        this.sequences["walk-left"] = { start:4, count:4, speed: 400, loop:true } as SpriteSequence;
        this.sequences["idle"] = { start:8, count:4, speed: 400, loop:true } as SpriteSequence;
